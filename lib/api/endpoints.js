...
export const ApiEndpoints = {
  ...
  // Not live on kaya-nest-api yet — pages the admin builds from blocks, and
  // a visible/hidden flag for the fixed pages above. See PAGE_BUILDER_API_READY
  // in lib/admin/store-api.js and docs/page-builder.md. The backend may fold
  // these into the pages module instead; adjust here if so.
  // Not live on kaya-nest-api yet — staff access to the website's customer
  // accounts (the website's own routes are /customer/*). See
  // CUSTOMERS_API_READY in lib/admin/store-api.js and docs/customers.md.
  customers: {
    adminList: `${V1}/admin/customers`,
    adminCounts: `${V1}/admin/customers/counts`,
    adminById: id => `${V1}/admin/customers/${id}`,
    adminMedical: id => `${V1}/admin/customers/${id}/medical`,
    adminAccessLog: id => `${V1}/admin/customers/${id}/access-log`,
    adminStatus: id => `${V1}/admin/customers/${id}/status`,
    adminExportCsv: `${V1}/admin/customers/export.csv`,
  },

  customPages: {
    adminList: `${V1}/admin/custom-pages`,
    adminById: id => `${V1}/admin/custom-pages/${id}`,
    publicBySlug: slug => `${V1}/public/custom-pages/${slug}`,
    adminVisibility: `${V1}/admin/pages-visibility`,
  },
