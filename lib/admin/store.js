...
export const fetchBlogs = (...a) => backend.fetchBlogs(...a)
export const fetchTellUs = (...a) => backend.fetchTellUs(...a)
export const persistTellUs = (...a) => backend.persistTellUs(...a)
export const fetchCustomPages = (...a) => backend.fetchCustomPages(...a)
export const persistCustomPages = (...a) => backend.persistCustomPages(...a)
export const removeCustomPage = (...a) => backend.removeCustomPage(...a)
export const fetchPageVisibility = (...a) => backend.fetchPageVisibility(...a)
export const persistPageVisibility = (...a) => backend.persistPageVisibility(...a)
...
export const persistBlogs = (...a) => backend.persistBlogs(...a)
...
export const removeBlog = (...a) => backend.removeBlog(...a)
...
export const fetchAnalyticsData = (...a) => backend.fetchAnalyticsData(...a)

export const fetchCustomersPage = (...a) => backend.fetchCustomersPage(...a)
export const fetchCustomerCounts = (...a) => backend.fetchCustomerCounts(...a)
export const fetchCustomer = (...a) => backend.fetchCustomer(...a)
export const revealCustomerMedical = (...a) => backend.revealCustomerMedical(...a)
export const fetchCustomerAccessLog = (...a) => backend.fetchCustomerAccessLog(...a)
export const setCustomerStatus = (...a) => backend.setCustomerStatus(...a)
export const removeCustomer = (...a) => backend.removeCustomer(...a)
export const exportCustomersCsv = (...a) => backend.exportCustomersCsv(...a)
