...
// Blog post lifecycle. Only `published` posts appear on the website.
export const BLOG_STATUS_OPTIONS = ['draft', 'published']
export const BLOG_STATUS_LABELS = { draft: 'Draft', published: 'Published' }

/**
 * An empty blog post for the "create" form. `titleAr`/`contentAr` are
 * optional — filling in both adds an Arabic translation.
 */
