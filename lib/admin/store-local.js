...
/** Demo Country records, shaped like the real admin API's CountryAdminResponseDto. Cities are derived from seedLocations so the clinic form's dropdowns line up with the demo clinics. */
  ...
  return [
    {
      ...
      isoCode: 'AE', dialCode: '+971', flagUrl: '', primaryCallNumber: '+97144501001',
      secondaryCallNumber: '', whatsappNumber: '+971501234567', preferredLanguage: 'EN',
      cities: toCities('UAE'),
    },
    {
      id: 'KSA', name: 'Saudi Arabia', nameAr: 'المملكة العربية السعودية', code: 'KSA',
      isoCode: 'SA', dialCode: '+966', flagUrl: '', primaryCallNumber: '+966114650000',
      secondaryCallNumber: '', whatsappNumber: '+966501234567', preferredLanguage: 'AR',
      cities: toCities('KSA'),
    },
    {
      id: 'Oman', name: 'Oman', nameAr: 'عُمان', code: 'Oman',
      isoCode: 'OM', dialCode: '+968', flagUrl: '', primaryCallNumber: '+96824560000',
      secondaryCallNumber: '', whatsappNumber: '', preferredLanguage: 'AR',
