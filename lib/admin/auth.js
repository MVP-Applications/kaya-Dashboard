 ...
 * manage users, or see customer accounts (which hold health data).
 */
export const PERMISSIONS = {
  admin: { create: true, edit: true, delete: true, manageUsers: true, viewCustomers: true },
  editor: { create: true, edit: true, delete: false, manageUsers: false, viewCustomers: false },
}
