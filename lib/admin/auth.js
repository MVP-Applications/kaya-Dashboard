 ...
 * manage users, see analytics (revenue included) or see customer accounts
 * (which hold health data).
 */
export const PERMISSIONS = {
  admin: { create: true, edit: true, delete: true, manageUsers: true, viewAnalytics: true, viewCustomers: true },
  editor: { create: true, edit: true, delete: false, manageUsers: false, viewAnalytics: false, viewCustomers: false },
}
